...
function Statisctic() {
  // const user = useSelector((store) => store.game.currentGame);
      ...
      {status && (
        <div className="statistic__table">
          <h2 className="statistic__title">Текущая игра</h2>
            <h3 className="statistic__user">Имя игрока: {results.userData}</h3>
          <div className="statistic__game">
            ...
            <div className="statistic__item">
              ...
              <div className="item__value item__btns">
                ...
                <button onClick={theEnd} className="item__btn btn-danger">
                  Завершить
                </button>
              </div>
            </div>
      ...
      {history && (
        <div className="statistic__table">
          ...
          {history.map((res, index) => (
            <>
              <h3 className="statistic__user">Имя игрока: {res.userData}</h3>
              <div className="statistic__game" key={index}>
                <div className="statistic__item">
                  <div className="item__title">Количество вопросов</div>
